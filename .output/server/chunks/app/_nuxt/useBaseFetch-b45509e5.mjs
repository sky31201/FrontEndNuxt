import { u as useRuntimeConfig, g as useNuxtApp, h as useRequestFetch, c as createError } from '../server.mjs';
...
const useBaseFetch = (request, opts) => {
...
export { useBaseFetch as u };
//# sourceMappingURL=useBaseFetch-b45509e5.mjs.map
